 ...
 */
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int): Double = (sagenes * 48 + arshins * 16 + vershoks)*4.445*0.01
 ...
 */
fun angleInRadian(grad: Int, min: Int, sec: Int): Double = (grad*Math.PI)/180+(min*Math.PI)/(180*60)+(sec* Math.PI)/(180*60*60)
 ...
 */
fun trackLength(x1: Double, y1: Double, x2: Double, y2: Double): Double = sqrt(pow(x1-x2, 2.0) + pow(y1-y2, 2.0))
...
fun accountInThreeYears(initial: Int, percent: Int): Double {
    ...
    val year3 = year2 + year2*percent*0.01
    return year3
...
fun numberRevert(number: Int): Int {
    val first = number % 10
    val cecond = (number % 100) / 10
    val third = number/100
    return first*100+cecond*10+third
